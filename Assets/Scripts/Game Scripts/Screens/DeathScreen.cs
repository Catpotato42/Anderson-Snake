...
public class DeathScreen : MonoBehaviour
{
    ...
    private string[] deathMessages0 = {"the snake language doesn't have a word for quit", "didn't see that wall?", "you matter to a snake somewhere", "unscaled, unpolished, can't slither.", "she herp on my- no hang on she python on- ok wait she"};
    ...
    private string[] deathMessages3 = {"Any herpetologists out there?", "slithered fr", "your name starts with an s", "I guess I should give you a real snake fact: they will never enjoy the feeling of a sunset run on a mountain trail. :("};
