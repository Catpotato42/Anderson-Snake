...
public class DeathScreen : MonoBehaviour
{
    ...
    private string[] deathMessages3 = {"Any snakeologists out there?", "slithered fr", "your name starts with an s", "I guess I should give you a real snake fact: they will never enjoy the feeling of a sunset run on a mountain trail. :("};
